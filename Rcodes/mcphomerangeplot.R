...
mcp_homerange_plot <- local({


mcp_homerange_plot <- function(ybdx, codebears0)
{
...
sp::plot(mcp, border = col, lwd = 2.25, add = TRUE)
...
dev.copy2pdf(file = "./Results/mcp95and50.pdf")
...
do.call("mcp_homerange_plot", list(ybdx, codebears0))
