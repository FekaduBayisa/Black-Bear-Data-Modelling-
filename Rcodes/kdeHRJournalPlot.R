...
xbdy[[hg]][[bc]] <- xy[grepl(as.character(codebears0[[hg]]$code[bc]), as.character(xy$id)), ]
...
FName <- paste(cwdd, "/Results/", "kdeJournal", dk,
...
sp::plot(homerange, border = col, lwd = 1.2, add = TRUE)
...
legend("bottom", inset = c(-0.75, 0.17), title = "Home Ranges of Black Bears",
...
legend("bottom", inset = c(-0.75, 0.19), title="Home Ranges of Black Bears",
